...
\begin{definition}
    ...
    \leanok
    \uses{def:characteristicSet, thm:initial_reducedToSet_of_cls_ne_bot, thm:characteristicSet_isAscendingSet, thm:characteristicSet_le_basicSet}
...
\begin{lemma}
    ...
    \lean{MvPolynomial.initialOf_add_eq_of_degreeOf_lt}
    \leanok
...
\begin{theorem}
    \label{thm:initial_reducedToSet_of_cls_ne_bot}
    \lean{AscendingSet.initial_reducedToSet_of_cls_ne_bot}
    \leanok
