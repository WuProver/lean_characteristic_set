...
\begin{definition}
    \label{def:TriangularSet.rank}
    \lean{TriangularSet.rank}
    \leanok
    \uses{def:TriangularSet, def:MvPolynomial.rank}
...
\begin{definition}
    ...
    \lean{HasBasicSet}
    \leanok
    \uses{def:TriangularSet, def:isAscendingSet, def:reducedToSet, def:TriangularSet.rank}
...
\begin{definition}
    ...
    \leanok
    \uses{def:TriangularSet, def:reducedToSet, def:TriangularSet.rank}
...
\begin{definition}
    ...
    \leanok
    \uses{def:initial, def:TriangularSet, def:reducedToSet, def:TriangularSet.rank}
...
\begin{lemma}
    ...
    \leanok
    \uses{def:reducedTo, def:MvPolynomial.rank}
...
\begin{theorem}
    ...
    \leanok
    \uses{def:TriangularSet, def:TriangularSet.rank}
    The set of Triangular Sets is well-founded under the lexicographic rank ordering. This guarantees the termination of the Characteristic Set Algorithm.
\end{theorem}
...
\begin{theorem}
    ...
    \leanok
    \uses{def:takeConcat, def:reducedToSet, def:TriangularSet.rank}
...
\begin{theorem}
    ...
    \leanok
    \uses{def:characteristicSet, def:TriangularSet.rank, def:HasBasicSet}
