...
\begin{definition}
    \label{def:MvPolynomial.order}
    \lean{MvPolynomial.order}
    \leanok
    \uses{def:mainDegree}
...
\begin{definition}
    \label{def:TriangularSet.order}
    \lean{TriangularSet.order}
    \leanok
    \uses{def:TriangularSet, def:MvPolynomial.order}
...
\begin{definition}
    ...
    \lean{TriangularSet.takeConcat}
    \leanok
    \uses{def:TriangularSet}
...
\begin{definition}
    ...
    satisfies $(\prod init(S_i)^{e_i}) \cdot g = \sum q_i \cdot S_i + r$ for some $\{e_i\}$ and $\{q_i\}$.
\end{definition}
...
\begin{definition}
    ...
    \leanok
    \uses{def:TriangularSet, def:initial, def:pseudo}
...
\begin{definition}
    ...
    \lean{TriangularSet.IsAscendingSet}
    \leanok
    \uses{def:TriangularSet, def:reducedTo}
...
\begin{definition}
    ...
    \lean{HasBasicSet}
    \leanok
    \uses{def:TriangularSet, def:IsAscendingSet, def:reducedToSet, def:TriangularSet.order}
...
\begin{definition}
    ...
    \leanok
    \uses{def:TriangularSet, def:reducedToSet, def:TriangularSet.order}
...
\begin{definition}
    ...
    \leanok
    \uses{def:initial, def:TriangularSet, def:reducedToSet, def:TriangularSet.order}
...
\begin{definition}
    ...
    \lean{TriangularSet.IsCharacteristicSet}
    \leanok
    \uses{def:TriangularSet, def:IsSetRemainder}
...
\begin{definition}
    ...
    \leanok
    \uses{def:TriangularSet, def:HasBasicSet, def:setPseudo, inst:TriangularSet.instWellFoundedLT, thm:basicSet_append_lt_of_exists_reducedToSet}
...
\begin{definition}
    ...
    \leanok
    \uses{def:characteristicSet, thm:initial_reducedToSet_of_max_vars_ne_bot, thm:characteristicSet_isAscendingSet, thm:characteristicSet_le_basicSet}
...
\begin{lemma}
    \label{lem:reducedTo_of_max_vars_lt}
    \lean{MvPolynomial.reducedTo_of_max_vars_lt}
    \leanok
    \uses{def:reducedTo}
...
\begin{lemma}
    \label{lem:reducedTo_iff_gt_of_max_vars_eq}
    \lean{MvPolynomial.reducedTo_iff_gt_of_max_vars_eq}
    \leanok
    \uses{def:reducedTo, def:MvPolynomial.order}
...
\begin{lemma}
    \label{lem:max_vars_lt_of_reducedTo_of_le}
    \lean{MvPolynomial.max_vars_lt_of_reducedTo_of_le}
    \leanok
    \uses{def:reducedTo}
...
\begin{proof}
    \leanok
    \uses{lem:reducedTo_iff_gt_of_max_vars_eq}
    % TODO
\end{proof}
...
\begin{lemma}
    \label{lem:max_vars_initial_lt}
    \lean{MvPolynomial.max_vars_initial_lt}
    \leanok
    \uses{def:initial}
...
\begin{proof}
    \leanok
    \uses{lem:reducedTo_of_max_vars_lt, lem:max_vars_initial_lt}
    % TODO
\end{proof}

\begin{theorem}
    \label{inst:TriangularSet.instWellFoundedLT}
    \lean{TriangularSet.instWellFoundedLT}
    \leanok
    \uses{def:TriangularSet, def:TriangularSet.order}
...
\begin{theorem}
    ...
    \lean{TriangularSet.takeConcat_lt_of_reducedToSet}
    \leanok
    \uses{def:takeConcat, def:reducedToSet, def:TriangularSet.order}
...
\begin{theorem}
    \label{thm:initial_reducedToSet_of_max_vars_ne_bot}
    \lean{AscendingSet.initial_reducedToSet_of_max_vars_ne_bot}
    \leanok
    \uses{def:initial, def:reducedToSet, def:IsAscendingSet}
...
\begin{proof}
    \leanok
    \uses{lem:max_vars_lt_of_reducedTo_of_le, thm:takeConcat_lt_of_reducedToSet}
    % TODO
\end{proof}
...
\begin{theorem}
    ...
    Appending an element which is reduced w.r.t. the basic set of list strictly decreases the order.
...
\begin{theorem}
    ...
    \leanok
    \uses{def:TriangularSet, def:IsSetRemainder, def:initialProd}
...
\begin{theorem}
    ...
    \leanok
    \uses{def:TriangularSet, def:IsCharacteristicSet, def:initialProd}
...
\begin{theorem}
    ...
    \leanok
    \uses{def:characteristicSet, def:TriangularSet.order, def:HasBasicSet}
...
\begin{proof}
    \leanok
    \uses{thm:characteristicSet_isCharacteristicSet, thm:vanishingSet_decomposition, inst:TriangularSet.instWellFoundedLT}
    % TODO
\end{proof}
