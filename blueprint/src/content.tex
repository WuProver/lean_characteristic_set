...
\begin{definition}
    ...
    \leanok
    \uses{def:pseudoOf, def:class}
    Pseudo-division of $g$ by $f$ with respect to $cls(f)$.
...
\begin{definition}
    ...
    \lean{HasBasicSet}
    \leanok
    \uses{def:TriangulatedSet, def:isAscendingSet, def:isMinimal, def:reducedToSet, def:TriangulatedSet.rank}
...
\begin{lemma}
    \label{lem:reducedTo_of_cls_lt}
    \lean{MvPolynomial.reducedTo_of_cls_lt}
    \leanok
    \uses{def:class, def:reducedTo}
    $q$ is reduced w.r.t. $p$ if $cls(q) < cls(p)$.
\end{lemma}
...
\begin{proof}
    \leanok
    \uses{lem:degreeOf_add_eq_of_degreeOf_lt}
    % TODO
\end{proof}
...
\begin{proof}
    \leanok
    \uses{lem:degreeOf_initialOf_self, lem:initialOf_add_eq_of_degreeOf_lt, lem:initialOf_eq_of_degreeOf_eq_zero, thm:initialOf_decomposition}
    % TODO
\end{proof}
...
\begin{lemma}
    \label{lem:cls_initial_lt}
    \lean{MvPolynomial.cls_initial_lt}
    \leanok
    \uses{def:class, def:initial}
    $cls(init(p)) < cls(p)$ for non-constant $p$.
\end{lemma}
...
\begin{proof}
    \leanok
    \uses{lem:reducedTo_of_cls_lt, lem:cls_initial_lt}
    % TODO
\end{proof}
...
\begin{proof}
    \leanok
    \uses{lem:degreeOf_initialOf_self, lem:initialOf_initialOf_self, lem:degreeOf_add_lt_of_initialOf_cancel, thm:degreeOf_mul, thm:initialOf_mul}
    % TODO
\end{proof}
...
\begin{proof}
    \leanok
    \uses{thm:degreeOf_mul, lem:degreeOf_pseudoOf_remainder_lt_of_degreeOf_ne_zero}
    % TODO
\end{proof}
...
\begin{theorem}
    ...
    \leanok
    \uses{def:pseudo}
    The remainder of $g$ by $f$ is $g$ if $deg_c(g) = 0$ where $c = cls(f)$.
\end{theorem}
...
\begin{proof}
    \leanok
    \uses{lem:cls_lt_of_reducedTo_of_le, thm:takeConcat_lt_of_reducedToSet}
    % TODO
\end{proof}
